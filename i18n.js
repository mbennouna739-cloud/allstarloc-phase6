...
(function () {
  ...
  fr: {
    ...
    'car.seats':'{n} places','car.unl':'Illimité','car.fromPrice':'À partir de','car.tierHint':'Tarif selon durée sélectionnée','car.book':'Réserver maintenant','car.addonsLabel':'Options en supplément',
  ...
  en: {
    ...
    'car.seats':'{n} seats','car.unl':'Unlimited','car.fromPrice':'From','car.tierHint':'Price based on selected duration','car.book':'Book now','car.addonsLabel':'Optional add-ons',
  ...
  es: {
    ...
    'car.seats':'{n} plazas','car.unl':'Ilimitado','car.fromPrice':'Desde','car.tierHint':'Precio según duración seleccionada','car.book':'Reservar ahora','car.addonsLabel':'Opciones adicionales',
  ...
  ar: {
    ...
    'car.seats':'{n} مقاعد','car.unl':'غير محدود','car.fromPrice':'ابتداءً من','car.tierHint':'السعر حسب المدة المختارة','car.book':'احجز الآن','car.addonsLabel':'خيارات إضافية',

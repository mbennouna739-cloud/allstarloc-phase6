...
(function () {
  ...
  fr: {
    ...
    'hero.badge':'Agence à Marrakech · Depuis 2018',
    ...
    'hero.f1':'Livraison aéroport gratuite','hero.f2':'Disponible 24h/24, 7j/7','hero.f3':'Service premium','hero.f4':'Assistance personnalisée',
    'bk.title':'Réservez votre voiture','bk.pickup':'Lieu de prise en charge','bk.return':'Lieu de retour','bk.dep':'Départ','bk.ret':'Retour',
    'bk.depSub':'Date de départ','bk.retSub':'Date de retour','bk.find':'Trouver une voiture','bk.dur':'Durée : {n} {d}',
    'u.day':'jour','u.days':'jours','u.perDay':'/j','u.perDayLong':'/ jour',
    ...
    'car.seats':'{n} places','car.unl':'Illimité','car.book':'Réserver maintenant',
    ...
    'why.t6':"7 Ans d'Expérience",'why.d6':'Plus de 500 clients satisfaits et une note de 4.8/5 sur Google confirment notre sérieux.',
    'rev.badge':'Avis Clients','rev.titleHtml':'Ce que Disent<br><span>Nos Clients</span>',
    'ft.tag':'Location de Voiture Marrakech',
    'ft.desc':'Votre agence de confiance depuis 2018. Flotte moderne, service premium, disponible 24h/7j. Livraison gratuite aéroport et hôtel.',
    ...
    'sum.rent':'Location véhicule ({n}j × {p})','sum.total':'TOTAL','sum.fullDisc':'Réduction paiement complet','sum.promo':'Code promo',
    'f.first':'Prénom','f.last':'Nom','f.email':'Email','f.phone':'Téléphone','f.wa':'WhatsApp','f.addr':'Adresse','f.country':'Pays / Nationalité','f.countryPh':'Sélectionner votre pays','f.flight':'Numéro de vol (optionnel)','f.notes':'Détails supplémentaires (optionnel)','f.docs':'Documents (optionnel)','f.lic':'N° Permis de conduire','f.pass':'N° Passeport / CIN','f.docsNote':'Documents vérifiés lors de la remise des clés. Upload possible en agence.',
    'ph.first':'Mohammed','ph.last':'Alami','ph.email':'email@exemple.com','ph.phone':'6XXXXXXXX','ph.addr':'Votre adresse complète','ph.flight':'AT234, RAM203...','ph.notes':"Heure d'arrivée, numéro de porte, demandes spéciales...",'ph.lic':'Ex: AB123456','ph.pass':'Ex: XX1234567','ph.promo':'Entrez votre code promo',
    ...
    'pay.termsHtml':'J\'ai lu et j\'accepte les <a href="pages/cgv.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">conditions générales de location</a> et la <a href="pages/privacy.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">politique de confidentialité</a> d\'ALL STAR LOC.',
    'pay.acceptAlert':'Veuillez accepter les conditions générales.',
    'cf.title':'Réservation Confirmée !',
    'cf.sub':'Merci {name} ! Votre demande de réservation a été enregistrée. Vous allez recevoir une confirmation par email et WhatsApp sous 15 minutes.',
    'cf.refLabel':'Numéro de réservation','cf.recap':'Récapitulatif','cf.total':'Total','cf.payFull':'Paiement complet','cf.payAdv':'Acompte 40%','cf.payOnsite':'Paiement sur place','cf.waBtn':'Confirmer via WhatsApp',
    ...
    'pf.copy':'© 2026 ALL STAR LOC — Location de voiture à Marrakech depuis 2018',
    'ab.badge':'Notre Histoire','ab.h1Html':'ALL STAR LOC,<br><span>depuis 2018 à Marrakech</span>',
    ...
    'ab.p1Html':'<strong>ALL STAR LOC</strong> est une agence de location de voitures basée à Marrakech, au 29 Rue Yougoslavie, en plein cœur de Guéliz. Depuis 2018, nous accompagnons voyageurs, familles et professionnels dans leurs déplacements à Marrakech et partout au Maroc.',
    ...
    'ab.numsHtml':"<strong>+500</strong> clients satisfaits · <strong>4.8/5</strong> sur Google · <strong>7 ans</strong> d'expérience · <strong>11+</strong> véhicules en flotte · Clients de <strong>15+ nationalités</strong>",
  ...
  en: {
    ...
    'hero.badge':'Marrakech Agency · Since 2018',
    ...
    'hero.f1':'Free airport delivery','hero.f2':'Available 24/7','hero.f3':'Premium service','hero.f4':'Personalised assistance',
    'bk.title':'Book your car','bk.pickup':'Pick-up location','bk.return':'Return location','bk.dep':'Pick-up','bk.ret':'Return',
    'bk.depSub':'Pick-up date','bk.retSub':'Return date','bk.find':'Find a car','bk.dur':'Duration: {n} {d}',
    'u.day':'day','u.days':'days','u.perDay':'/day','u.perDayLong':'/ day',
    ...
    'car.seats':'{n} seats','car.unl':'Unlimited','car.book':'Book now',
    ...
    'why.t6':'7 Years of Experience','why.d6':'Over 500 satisfied customers and a 4.8/5 rating on Google confirm our reliability.',
    'rev.badge':'Customer Reviews','rev.titleHtml':'What Our<br><span>Customers Say</span>',
    'ft.tag':'Car Rental Marrakech',
    'ft.desc':'Your trusted agency since 2018. Modern fleet, premium service, available 24/7. Free airport and hotel delivery.',
    ...
    'sum.rent':'Vehicle rental ({n}d × {p})','sum.total':'TOTAL','sum.fullDisc':'Full payment discount','sum.promo':'Promo code',
    'f.first':'First name','f.last':'Last name','f.email':'Email','f.phone':'Phone','f.wa':'WhatsApp','f.addr':'Address','f.country':'Country / Nationality','f.countryPh':'Select your country','f.flight':'Flight number (optional)','f.notes':'Additional details (optional)','f.docs':'Documents (optional)','f.lic':'Driving licence no.','f.pass':'Passport / ID no.','f.docsNote':'Documents checked at key handover. Upload possible at the agency.',
    'ph.first':'John','ph.last':'Smith','ph.email':'email@example.com','ph.phone':'6XXXXXXXX','ph.addr':'Your full address','ph.flight':'AT234, RAM203...','ph.notes':'Arrival time, gate number, special requests...','ph.lic':'E.g. AB123456','ph.pass':'E.g. XX1234567','ph.promo':'Enter your promo code',
    ...
    'pay.termsHtml':'I have read and accept ALL STAR LOC\'s <a href="pages/cgv.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">rental terms and conditions</a> and <a href="pages/privacy.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">privacy policy</a>.',
    'pay.acceptAlert':'Please accept the terms and conditions.',
    'cf.title':'Booking Confirmed!',
    'cf.sub':'Thank you {name}! Your booking request has been recorded. You will receive a confirmation by email and WhatsApp within 15 minutes.',
    'cf.refLabel':'Booking reference','cf.recap':'Summary','cf.total':'Total','cf.payFull':'Full payment','cf.payAdv':'40% deposit','cf.payOnsite':'Pay on site','cf.waBtn':'Confirm via WhatsApp',
    ...
    'pf.copy':'© 2026 ALL STAR LOC — Car rental in Marrakech since 2018',
    'ab.badge':'Our Story','ab.h1Html':'ALL STAR LOC,<br><span>in Marrakech since 2018</span>',
    'ab.lead':'A family-run car rental agency built on trust, transparency and service.',
    'ab.who':'Who are we?',
    'ab.p1Html':'<strong>ALL STAR LOC</strong> is a car rental agency based in Marrakech, at 29 Rue Yougoslavie, in the heart of Guéliz. Since 2018, we have been supporting travellers, families and professionals in their journeys around Marrakech and throughout Morocco.',
    ...
    'ab.numsHtml':'<strong>+500</strong> satisfied customers · <strong>4.8/5</strong> on Google · <strong>7 years</strong> of experience · <strong>11+</strong> vehicles in the fleet · Customers from <strong>15+ nationalities</strong>',
  ...
  es: {
    ...
    'hero.badge':'Agencia en Marrakech · Desde 2018',
    ...
    'hero.f1':'Entrega gratuita en el aeropuerto','hero.f2':'Disponible 24h/7','hero.f3':'Servicio premium','hero.f4':'Asistencia personalizada',
    'bk.title':'Reserve su coche','bk.pickup':'Lugar de recogida','bk.return':'Lugar de devolución','bk.dep':'Salida','bk.ret':'Devolución',
    'bk.depSub':'Fecha de salida','bk.retSub':'Fecha de devolución','bk.find':'Buscar un coche','bk.dur':'Duración: {n} {d}',
    'u.day':'día','u.days':'días','u.perDay':'/día','u.perDayLong':'/ día',
    ...
    'car.seats':'{n} plazas','car.unl':'Ilimitado','car.book':'Reservar ahora',
    ...
    'why.t6':'7 Años de Experiencia','why.d6':'Más de 500 clientes satisfechos y una nota de 4.8/5 en Google confirman nuestra seriedad.',
    ...
    'ft.desc':'Su agencia de confianza desde 2018. Flota moderna, servicio premium, disponible 24h/7. Entrega gratuita en aeropuerto y hotel.',
    ...
    'sum.rent':'Alquiler del vehículo ({n}d × {p})','sum.total':'TOTAL','sum.fullDisc':'Descuento pago completo','sum.promo':'Código promocional',
    'f.first':'Nombre','f.last':'Apellido','f.email':'Email','f.phone':'Teléfono','f.wa':'WhatsApp','f.addr':'Dirección','f.country':'País / Nacionalidad','f.countryPh':'Seleccione su país','f.flight':'Número de vuelo (opcional)','f.notes':'Detalles adicionales (opcional)','f.docs':'Documentos (opcional)','f.lic':'N° Permiso de conducir','f.pass':'N° Pasaporte / DNI','f.docsNote':'Documentos verificados en la entrega de llaves. Posible subirlos en la agencia.',
    'ph.first':'Carlos','ph.last':'García','ph.email':'email@ejemplo.com','ph.phone':'6XXXXXXXX','ph.addr':'Su dirección completa','ph.flight':'AT234, RAM203...','ph.notes':'Hora de llegada, número de puerta, peticiones especiales...','ph.lic':'Ej: AB123456','ph.pass':'Ej: XX1234567','ph.promo':'Introduzca su código promocional',
    ...
    'pay.termsHtml':'He leído y acepto las <a href="pages/cgv.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">condiciones generales de alquiler</a> y la <a href="pages/privacy.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">política de privacidad</a> de ALL STAR LOC.',
    'pay.acceptAlert':'Por favor, acepte las condiciones generales.',
    'cf.title':'¡Reserva Confirmada!',
    'cf.sub':'¡Gracias {name}! Su solicitud de reserva ha sido registrada. Recibirá una confirmación por email y WhatsApp en menos de 15 minutos.',
    'cf.refLabel':'Número de reserva','cf.recap':'Resumen','cf.total':'Total','cf.payFull':'Pago completo','cf.payAdv':'Anticipo 40%','cf.payOnsite':'Pago en el lugar','cf.waBtn':'Confirmar por WhatsApp',
    ...
    'pf.copy':'© 2026 ALL STAR LOC — Alquiler de coches en Marrakech desde 2018',
    'ab.badge':'Nuestra Historia','ab.h1Html':'ALL STAR LOC,<br><span>desde 2018 en Marrakech</span>',
    ...
    'ab.p1Html':'<strong>ALL STAR LOC</strong> es una agencia de alquiler de coches con sede en Marrakech, en el 29 Rue Yougoslavie, en pleno corazón de Guéliz. Desde 2018, acompañamos a viajeros, familias y profesionales en sus desplazamientos por Marrakech y todo Marruecos.',
    ...
    'ab.numsHtml':'<strong>+500</strong> clientes satisfechos · <strong>4.8/5</strong> en Google · <strong>7 años</strong> de experiencia · <strong>11+</strong> vehículos en flota · Clientes de <strong>15+ nacionalidades</strong>',
  ...
  ar: {
    ...
    'hero.badge':'وكالة في مراكش · منذ 2018',
    ...
    'hero.f1':'توصيل مجاني إلى المطار','hero.f2':'متوفرون 24/7','hero.f3':'خدمة راقية','hero.f4':'مساعدة شخصية',
    'bk.title':'احجز سيارتك','bk.pickup':'مكان الاستلام','bk.return':'مكان الإرجاع','bk.dep':'الانطلاق','bk.ret':'الإرجاع',
    'bk.depSub':'تاريخ الانطلاق','bk.retSub':'تاريخ الإرجاع','bk.find':'ابحث عن سيارة','bk.dur':'المدة : {n} {d}',
    ...
    'car.seats':'{n} مقاعد','car.unl':'غير محدود','car.book':'احجز الآن',
    ...
    'why.t6':'7 سنوات من الخبرة','why.d6':'أكثر من 500 زبون راضٍ وتقييم 4.8/5 على غوغل يؤكدان جديتنا.',
    'rev.badge':'آراء الزبناء','rev.titleHtml':'ماذا يقول<br><span>زبناؤنا</span>',
    'ft.tag':'كراء السيارات مراكش',
    'ft.desc':'وكالتكم الموثوقة منذ 2018. أسطول حديث، خدمة راقية، متوفرون 24/7. توصيل مجاني إلى المطار والفندق.',
    ...
    'sum.rent':'كراء السيارة ({n} أيام × {p})','sum.total':'المجموع','sum.fullDisc':'خصم الدفع الكامل','sum.promo':'رمز ترويجي',
    'f.first':'الاسم الشخصي','f.last':'الاسم العائلي','f.email':'البريد الإلكتروني','f.phone':'الهاتف','f.wa':'واتساب','f.addr':'العنوان','f.country':'البلد / الجنسية','f.countryPh':'اختر بلدك','f.flight':'رقم الرحلة (اختياري)','f.notes':'تفاصيل إضافية (اختياري)','f.docs':'الوثائق (اختياري)','f.lic':'رقم رخصة السياقة','f.pass':'رقم جواز السفر / البطاقة الوطنية','f.docsNote':'يتم التحقق من الوثائق عند تسليم المفاتيح. يمكن رفعها في الوكالة.',
    'ph.first':'محمد','ph.last':'العلمي','ph.email':'email@example.com','ph.phone':'6XXXXXXXX','ph.addr':'عنوانكم الكامل','ph.flight':'AT234, RAM203...','ph.notes':'وقت الوصول، رقم البوابة، طلبات خاصة...','ph.lic':'مثال: AB123456','ph.pass':'مثال: XX1234567','ph.promo':'أدخلوا الرمز الترويجي',
    ...
    'pay.termsHtml':'قرأت وأوافق على <a href="pages/cgv.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">الشروط العامة للكراء</a> و<a href="pages/privacy.html" target="_blank" rel="noopener" onclick="event.stopPropagation()">سياسة الخصوصية</a> الخاصة بـ ALL STAR LOC.',
    'pay.acceptAlert':'المرجو الموافقة على الشروط العامة.',
    'cf.title':'تم تأكيد الحجز !',
    'cf.sub':'شكراً {name} ! تم تسجيل طلب حجزكم. ستتوصلون بتأكيد عبر البريد الإلكتروني وواتساب خلال 15 دقيقة.',
    'cf.refLabel':'رقم الحجز','cf.recap':'الملخص','cf.total':'المجموع','cf.payFull':'دفع كامل','cf.payAdv':'تسبيق 40%','cf.payOnsite':'الدفع في عين المكان','cf.waBtn':'التأكيد عبر واتساب',
    ...
    'pf.copy':'© 2026 ALL STAR LOC — كراء السيارات في مراكش منذ 2018',
    'ab.badge':'قصتنا','ab.h1Html':'ALL STAR LOC،<br><span>منذ 2018 في مراكش</span>',
    'ab.lead':'وكالة عائلية لكراء السيارات، مبنية على الثقة والشفافية والخدمة.',
    'ab.who':'من نحن ؟',
    'ab.p1Html':'<strong>ALL STAR LOC</strong> وكالة لكراء السيارات مقرها مراكش، في 29 شارع يوغوسلافيا، في قلب حي گيليز. منذ 2018، نرافق المسافرين والعائلات والمهنيين في تنقلاتهم بمراكش وفي جميع أنحاء المغرب.',
    ...
    'ab.nums':'بعض الأرقام',
    'ab.numsHtml':'<strong>+500</strong> زبون راضٍ · <strong>4.8/5</strong> على غوغل · <strong>7 سنوات</strong> من الخبرة · <strong>+11</strong> سيارة في الأسطول · زبناء من <strong>+15 جنسية</strong>',

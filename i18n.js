...
(function () {
  ...
  fr: {
    ...
    'vp.h1':'Notre flotte de location à Marrakech','vp.lead':'Citadines, berlines et SUV récents — assurance incluse, kilométrage illimité et tarifs dégressifs selon la durée.','vp.degressive':'Tarifs dégressifs selon la durée de location.','vp.ctaTitle':'Prêt à trouver votre véhicule ?','vp.ctaText':'Sélectionnez vos dates afin de découvrir les véhicules disponibles pendant votre séjour à Marrakech.','vp.ctaBtn':'Vérifier les disponibilités','vp.degressive2':'Tarifs dégressifs selon la durée de location.','vp.from':'À partir de','vp.bookNow':'Réserver maintenant','vp.howto':'Comment ça marche ?','misc.cat':'Catégorie : ','u.bags':'bagages','vp.empty':'Aucun véhicule dans cette catégorie pour le moment.','u.seats':'places','u.day':'jour','u.days':'jours','u.perDay':'/j','u.perDayLong':'/ jour',
    ...
    'fleet.sub':'Tous nos véhicules sont récents, propres et régulièrement entretenus, avec des tarifs dégressifs selon la durée de location.',
  ...
  en: {
    ...
    'vp.h1':'Our rental fleet in Marrakech','vp.lead':'Recent city cars, sedans and SUVs — insurance included, unlimited mileage and tiered pricing.','vp.degressive':'Tiered pricing by rental duration.','vp.ctaTitle':'Ready to find your vehicle?','vp.ctaText':'Select your dates to discover the vehicles available for your stay in Marrakech.','vp.ctaBtn':'Check availability','vp.degressive2':'Tiered pricing by rental duration.','vp.from':'From','vp.bookNow':'Book now','vp.howto':'How does it work?','misc.cat':'Category: ','u.bags':'bags','vp.empty':'No vehicles in this category at the moment.','u.seats':'seats','u.day':'day','u.days':'days','u.perDay':'/day','u.perDayLong':'/ day',
    ...
    'fleet.sub':'All our vehicles are recent, clean and regularly serviced, with tiered pricing based on rental duration.',
  ...
  es: {
    ...
    'vp.h1':'Nuestra flota de alquiler en Marrakech','vp.lead':'Utilitarios, berlinas y SUV recientes — seguro incluido, kilometraje ilimitado y tarifas decrecientes.','vp.degressive':'Tarifas decrecientes según la duración del alquiler.','vp.ctaTitle':'¿Listo para encontrar su vehículo?','vp.ctaText':'Seleccione sus fechas para descubrir los vehículos disponibles durante su estancia en Marrakech.','vp.ctaBtn':'Consultar disponibilidad','vp.degressive2':'Tarifas decrecientes según la duración del alquiler.','vp.from':'Desde','vp.bookNow':'Reservar ahora','vp.howto':'¿Cómo funciona?','misc.cat':'Categoría: ','u.bags':'maletas','vp.empty':'No hay vehículos en esta categoría por el momento.','u.seats':'plazas','u.day':'día','u.days':'días','u.perDay':'/día','u.perDayLong':'/ día',
    ...
    'fleet.sub':'Todos nuestros vehículos son recientes, limpios y con mantenimiento regular, con tarifas decrecientes según la duración del alquiler.',
  ...
  ar: {
    ...
    'vp.h1':'أسطولنا للكراء في مراكش','vp.lead':'سيارات مدينة وسيدان وسيارات SUV حديثة — التأمين مشمول، مسافة غير محدودة وأسعار تنازلية.','vp.degressive':'أسعار تنازلية حسب مدة الكراء.','vp.ctaTitle':'هل أنت مستعد لإيجاد سيارتك؟','vp.ctaText':'اختر تواريخك لاكتشاف السيارات المتاحة خلال إقامتك في مراكش.','vp.ctaBtn':'التحقق من التوفر','vp.degressive2':'أسعار تنازلية حسب مدة الكراء.','vp.from':'ابتداءً من','vp.bookNow':'احجز الآن','vp.howto':'كيف يعمل؟','misc.cat':'الفئة: ','u.bags':'حقائب','vp.empty':'لا توجد سيارات في هذه الفئة حالياً.','u.seats':'مقاعد','u.day':'يوم','u.days':'أيام','u.perDay':'/يوم','u.perDayLong':'/ يوم',
    ...
    'fleet.sub':'جميع سياراتنا حديثة ونظيفة وتخضع لصيانة منتظمة، مع أسعار تنازلية حسب مدة الكراء.',

...
(function (global) {
  ...
  const DEFAULT_FLEET = [
    { id:1,  name:'Kia Picanto',           category:'citadine',   priceEUR:25, priceMAD:250, plate:'ABC-123-MK', status:'available',   fuel:'Diesel',  transmission:'Automatique', seats:5, badge:'Mini-Urbaine', featured:false, services:['Clim','Radio','GPS'],            img:'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=600&q=80',
      shortDescI18n:{ fr:"Parfaite pour vos déplacements en ville, la Kia Picanto offre une conduite fluide, une faible consommation et un stationnement facile dans les ruelles animées de Marrakech. Idéale pour un premier voyage en solo ou en couple, sans compromis sur le confort." } },
    { id:2,  name:'Hyundai Grand i10',     category:'citadine',   priceEUR:30, priceMAD:300, plate:'DEF-456-MK', status:'reserved',    fuel:'Essence', transmission:'Automatique', seats:5, badge:'Économique',   featured:false, services:['Clim','Radio','USB'],            img:'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=600&q=80',
      shortDescI18n:{ fr:"Compacte et confortable, la Hyundai Grand i10 séduit par son habitabilité surprenante et sa consommation maîtrisée. Un excellent compromis pour explorer la médina et les environs de Marrakech sans se soucier du budget carburant." } },
    { id:3,  name:'Fiat 500',              category:'citadine',   priceEUR:30, priceMAD:300, plate:'GHI-789-MK', status:'available',   fuel:'Essence', transmission:'Automatique', seats:5, badge:'Citadine',     featured:false, services:['Clim','Bluetooth','Style'],      img:'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?w=600&q=80',
      shortDescI18n:{ fr:"Icône du design italien, la Fiat 500 allie style et praticité pour sillonner Marrakech avec élégance. Son gabarit compact facilite le stationnement, tandis que son allure chic en fait la citadine préférée des amateurs de belles photos de voyage." } },
    { id:4,  name:'Peugeot 208',           category:'citadine',   priceEUR:30, priceMAD:300, plate:'JKL-012-MK', status:'available',   fuel:'Diesel',  transmission:'Automatique', seats:5, badge:'Moderne',      featured:false, services:['Clim','GPS','USB'],              img:'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=600&q=80',
      shortDescI18n:{ fr:"Moderne et technologique, la Peugeot 208 embarque GPS et connectivité USB pour des trajets sereins dans la région de Marrakech. Sa ligne dynamique et son confort de conduite en font une citadine polyvalente, aussi bien en ville que sur route." } },
    { id:5,  name:'Opel Corsa',            category:'economique', priceEUR:30, priceMAD:300, plate:'MNO-345-MK', status:'maintenance', fuel:'Diesel',  transmission:'Automatique', seats:5, badge:'Économique',   featured:false, services:['Clim','Radio','Bluetooth'],      img:'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=600&q=80',
      shortDescI18n:{ fr:"Fiable et économique, l'Opel Corsa est le choix malin des voyageurs qui recherchent une location de voiture à Marrakech sans mauvaise surprise. Faible consommation, entretien récent et confort suffisant pour tous vos trajets du quotidien." } },
    { id:6,  name:'Renault Clio 5',        category:'economique', priceEUR:30, priceMAD:300, plate:'PQR-678-MK', status:'available',   fuel:'Diesel',  transmission:'Manuelle',    seats:5, badge:'Compacte',     featured:false, services:['Clim','GPS','Radio'],            img:'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600&q=80',
      shortDescI18n:{ fr:"Référence des compactes françaises, la Renault Clio 5 conjugue confort de conduite, équipements modernes et fiabilité éprouvée. Un choix rassurant pour découvrir Marrakech et sa région au volant d'un véhicule récent et bien entretenu." } },
    { id:7,  name:'Peugeot 301',           category:'familiale',  priceEUR:28, priceMAD:280, plate:'STU-901-MK', status:'available',   fuel:'Diesel',  transmission:'Manuelle',    seats:5, badge:'Familiale',    featured:false, services:['Clim','Grand Coffre','Confort'], img:'https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=600&q=80',
      shortDescI18n:{ fr:"Berline familiale au grand coffre, la Peugeot 301 est idéale pour les familles et les longs séjours à Marrakech. Confortable sur route, elle offre l'espace nécessaire pour les bagages d'un séjour prolongé ou d'un road trip vers le Sud marocain." } },
    { id:8,  name:'Citroën C-Élysée',      category:'familiale',  priceEUR:30, priceMAD:300, plate:'VWX-234-MK', status:'available',   fuel:'Diesel',  transmission:'Manuelle',    seats:5, badge:'Spacieuse',    featured:false, services:['Clim','Grand Coffre','Confort'], img:'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=600&q=80',
      shortDescI18n:{ fr:"Spacieuse et silencieuse, la Citroën C-Élysée offre un excellent rapport confort-prix pour vos déplacements en famille autour de Marrakech. Sa suspension souple absorbe parfaitement les routes marocaines, pour un voyage détendu du début à la fin." } },
    { id:9,  name:'Dacia Sandero Stepway', category:'economique', priceEUR:30, priceMAD:300, plate:'YZA-567-MK', status:'available',   fuel:'Diesel',  transmission:'Manuelle',    seats:5, badge:'Polyvalente',  featured:false, services:['Clim','Hauteur','Coffre'],       img:'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&q=80',
      shortDescI18n:{ fr:"Avec sa garde au sol surélevée façon crossover, la Dacia Sandero Stepway aborde sereinement les pistes et nids-de-poule autour de Marrakech. Polyvalente et économique, elle convient aussi bien à la ville qu'aux excursions dans la campagne environnante." } },
    { id:10, name:'Dacia Sandero Streetway', category:'economique', priceEUR:28, priceMAD:280, plate:'HIJ-345-MK', status:'available', fuel:'Essence', transmission:'Manuelle',    seats:5, badge:'Citadine',     featured:false, services:['Clim','Radio','Bluetooth'],      img:'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&q=80',
      shortDescI18n:{ fr:"Version urbaine et agile de la gamme Sandero, la Dacia Sandero Streetway se faufile aisément dans les rues animées de Marrakech. Un excellent rapport qualité-prix pour les voyageurs qui privilégient la simplicité et un budget maîtrisé." } },
    { id:11, name:'Dacia Duster',          category:'suv',        priceEUR:40, priceMAD:400, plate:'BCD-890-MK', status:'available',   fuel:'Diesel',  transmission:'Manuelle',    seats:5, badge:'SUV',          featured:true,  services:['4x4','Clim','GPS','Grand Coffre'], img:'https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?w=600&q=80',
      shortDescI18n:{ fr:"Robuste et polyvalent, le Dacia Duster est le compagnon idéal pour affronter les pistes de l'Atlas comme les avenues de Marrakech. Son grand coffre et sa garde au sol généreuse en font le SUV de référence pour les excursions dans le désert et la montagne." } },
    { id:12, name:'Kia Sportage',          category:'suv',        priceEUR:70, priceMAD:700, plate:'EFG-123-MK', status:'available',   fuel:'Diesel',  transmission:'Automatique', seats:5, badge:'Premium SUV',  featured:true,  services:['SUV Premium','Auto','GPS','Cuir'], img:'https://images.unsplash.com/photo-1617469767280-f8b69f46b1b0?w=600&q=80',
      shortDescI18n:{ fr:"SUV premium à la finition soignée, le Kia Sportage offre espace, confort et prestance pour vos déplacements en famille ou entre amis à Marrakech. Sellerie cuir, boîte automatique et grand coffre : le choix haut de gamme pour un séjour tout confort." } },
    { id:13, name:'Dacia Sandero Streetway Automatique', category:'economique', priceEUR:32, priceMAD:320, plate:'KLM-678-MK', status:'available', fuel:'Essence', transmission:'Automatique', seats:5, badge:'Automatique', featured:false, services:['Clim','Boîte auto','Radio'],     img:'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&q=80',
      shortDescI18n:{ fr:"La Dacia Sandero Streetway en boîte automatique combine simplicité de conduite et budget maîtrisé, idéale pour circuler sereinement dans le trafic marrakchi. Parfaite pour les conducteurs qui préfèrent l'automatique pour un séjour sans stress." } },
  ];
  ...
  */
  ...
  /* ============================================================
     ★ CORRECTIF (synchronisation équipements personnalisés) — Le module
     admin-custom-features.js (back-office) n'est chargé QUE dans le
     back-office, jamais sur le site client (index.html / nos-vehicules.html).
     Les définitions (nom + icône) étaient donc enregistrées et synchronisées
     via KV (clé 'asl_custom_features_v1', déjà dans MISC_MAP), mais aucune
     page client ne pouvait les LIRE ni afficher leur icône : `car.customFeatures`
     (par véhicule) arrivait bien, mais la liste nom/icône elle-même restait
     invisible côté site. Ces deux fonctions, chargées partout via data.js,
     comblent ce manque sans dupliquer la logique d'écriture (réservée au
     back-office) : lecture seule de la même clé KV, même jeu d'icônes que
     le sélecteur du back-office. ============================================================ */
  var CUSTOM_FEATURES_KEY = 'asl_custom_features_v1';
  var CUSTOM_FEATURE_ICONS = {
    'wifi':        '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.55a11 11 0 0 1 14.08 0"/><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><circle cx="12" cy="20" r="1"/></svg>',
    'smartphone':  '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="20" x="5" y="2" rx="2" ry="2"/><path d="M12 18h.01"/></svg>',
    'tablet':      '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><line x1="12" x2="12.01" y1="18" y2="18"/></svg>',
    'navigation':  '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polygon points="3 11 22 2 13 21 11 13 3 11"/></svg>',
    'camera':      '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg>',
    'usb':         '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="7" r="1"/><circle cx="14" cy="7" r="1"/><path d="M12 20v-8"/><path d="M8 20h8"/><path d="M12 4v3"/><path d="M9 7h6l1 5H8l1-5Z"/></svg>',
    ...
    'sun':         '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>',
    'thermometer': '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"/></svg>',
    ...
    'zap':         '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/></svg>',
    'star':        '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',
    ...
    'map-pin':     '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/></svg>',
    'baby':        '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12h.01"/><path d="M15 12h.01"/><path d="M10 16c.5.3 1.2.5 2 .5s1.5-.2 2-.5"/><path d="M19 6.3a9 9 0 0 1 1.8 3.9 2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3.5 1.1 3.5 2.5s-.9 2.5-2 2.5c-.8 0-1.5-.4-1.5-1"/></svg>',
    'car':         '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17H5v2H3V9l2-5h14l2 5v10h-2v-2Z"/><path d="M7 17h10"/><circle cx="7.5" cy="14.5" r="1.5"/><circle cx="16.5" cy="14.5" r="1.5"/></svg>',
